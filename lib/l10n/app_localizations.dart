...
abstract class AppLocalizations {
  ...
  /// No description provided for @ordersStatusIncomplete.
  ///
  /// In en, this message translates to:
  /// **'Incomplete'**
  String get ordersStatusIncomplete;
  ...
  /// No description provided for @orderStatusWaitingForPayment.
  ///
  /// In en, this message translates to:
  /// **'Waiting for payment'**
  String get orderStatusWaitingForPayment;
